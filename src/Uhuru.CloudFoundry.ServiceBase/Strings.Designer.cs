...
namespace Uhuru.CloudFoundry.ServiceBase {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}.cleanupnfs_instance.{1}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}.update_instance.{1}.
        /// </summary>
        internal static string NatsSubjectUpdateInstance {
            get {
                return ResourceManager.GetString("NatsSubjectUpdateInstance", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}: Update instance {1} request from: {2}.
        /// </summary>
        internal static string OnUpdateInstanceRequestDebugLogMessage {
            get {
                return ResourceManager.GetString("OnUpdateInstanceRequestDebugLogMessage", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Provision request has no version specified. Provisioning with default version..
        /// </summary>
        internal static string ProvisionBackwardsCompatibilityModeInfoMessage {
            get {
                return ResourceManager.GetString("ProvisionBackwardsCompatibilityModeInfoMessage", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unsupported service version..
        /// </summary>
        internal static string ServiceExceptionUnsupportedVersion {
            get {
                return ResourceManager.GetString("ServiceExceptionUnsupportedVersion", resourceCulture);
            }
        }
