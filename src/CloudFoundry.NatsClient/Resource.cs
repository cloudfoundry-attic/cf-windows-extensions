namespace CloudFoundry.NatsClient
{
    ...
    public class Resource
    {
        ...
        private Resource()
        {
            this.msg = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.MSG);
            this.ok = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.OK);
            this.err = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.ERR);
            this.ping = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.PING);
            this.pong = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.PONG);
            this.info = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.INFO);
            this.unknown = new Regex(CloudFoundry.NatsClient.Resources.ClientConnection.UNKNOWN);
        }
