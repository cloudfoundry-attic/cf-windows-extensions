namespace CloudFoundry.Utilities
{
    ...
    public static class PlatformTarget
    {
        ...
        public static CpuTarget DetectPlatform(string assemblyPath)
        {
            ...
            try
            {
                LoadAssemblyHelper obj = (LoadAssemblyHelper)domain.CreateInstanceFromAndUnwrap(Assembly.GetExecutingAssembly().Location, "CloudFoundry.Utilities.LoadAssemblyHelper");
